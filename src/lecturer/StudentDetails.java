...
public class StudentDetails extends javax.swing.JFrame implements CRUD_Operation_Interface{
    ...
    private void tableviewStudentDetails(){
        getDetails(studentDetail_table, "","");
        model = (DefaultTableModel) studentDetail_table.getModel();
    }
    ...
    private void initComponents() {
        ...
        studentDetail_table = new rojeru_san.complementos.RSTableMetro();
        ...
        studentDetail_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        studentDetail_table.setFuenteHead(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        studentDetail_table.setRowHeight(30);
        jScrollPane1.setViewportView(studentDetail_table);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(27, 27, 27)
                        .addComponent(txt_search, javax.swing.GroupLayout.PREFERRED_SIZE, 348, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
        ...
        lbl_student.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 2, new java.awt.Color(255, 255, 255)));
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        if(txt_search.getText().isEmpty()){
            ...
            getDetails(studentDetail_table, txt_search.getText(),"");
        }
    ...
    private rojeru_san.complementos.RSTableMetro studentDetail_table;
