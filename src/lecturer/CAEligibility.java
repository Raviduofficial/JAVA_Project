...
public class CAEligibility extends javax.swing.JFrame implements CRUD_Operation_Interface{
    ...
    public CAEligibility(String userId) {
        ...
        initComponents();
        setResizable(false);
        getDetails(tbl_eligibility, "",currentUserId);
    }
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        if(txt_search.getText().isEmpty()){
            ...
            getDetails(tbl_eligibility, txt_search.getText(),currentUserId);
        }
