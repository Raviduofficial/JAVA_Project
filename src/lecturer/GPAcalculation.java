...
public class GPAcalculation extends javax.swing.JFrame implements CRUD_Operation_Interface{
    ...
    private void initComponents() {
        ...
        jPanel13.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 200, 110));
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        if(txt_search.getText().isEmpty()){
            ...
            getDetails(tbl_gpa, txt_search.getText(),"");
        }
