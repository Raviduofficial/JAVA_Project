...
public class MedicalLEC extends javax.swing.JFrame implements CRUD_Operation_Interface{
    ...
    public void getDetails(RSTableMetro table, String searchValue, String lecId) {
        String sql = "SELECT m.medical_id,m.course_id ,m.ug_id ,m.medical_date   FROM medical m "
    ...
    private void tableviewMedical(){
        getDetails(tbl_medical, "" , currentUserId);
    ...
    private void initComponents() {
        ...
        tbl_medical.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Medical ID", "Course Code", "Student ID", "Medical Date"
            }
        ) {
        ...
        lbl_medical.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 2, new java.awt.Color(255, 255, 255)));
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        if(txt_search.getText().isEmpty()){
            ...
            getDetails(tbl_medical, txt_search.getText() , currentUserId);
        }
