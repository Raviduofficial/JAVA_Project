...
public class Lecture_profile extends javax.swing.JFrame {
    ...
    public void update(String name, String email, String phone, String profilePicPath, String userId) {
        String sql = "UPDATE user SET user_name=?, user_email=?, user_phone=?, user_pro_pic=? WHERE user_id=?";
    ...
    private void initComponents() {
        ...
        ProPicPath = new app.bolivia.swing.JCTextField();
        ...
        lecPhoto.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jPanel3.add(lecPhoto, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 97, 150, 160));
        ...
        ProPicPath.setBackground(new java.awt.Color(140, 140, 140));
        ProPicPath.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ProPicPath.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jPanel3.add(ProPicPath, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 270, 300, -1));
        ...
        lbl_name6.setForeground(new java.awt.Color(0, 0, 0));
...
//            new Login().setVisible(true);
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        update(userName, userEmail, userPhone, userPass, userId);
    }//GEN-LAST:event_btn_updateActionPerformed
    


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private app.bolivia.swing.JCTextField ProPicPath;
