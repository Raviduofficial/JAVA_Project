...
public class MedicalLEC extends javax.swing.JFrame {
            ...
            try(ResultSet result = ps.executeQuery()){
                ...
                while(result.next()){
                    model.addRow(new Object[]{
                        ...
                        result.getString("medical_status")
                    });
                }
            }
    ...
    private void initComponents() {
        ...
        tbl_medical.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Medical ID", "Course Code", "Student ID", "Medical Date", "Status"
            }
        ) {
        ...
        if (tbl_medical.getColumnModel().getColumnCount() > 0) {
            tbl_medical.getColumnModel().getColumn(4).setResizable(false);
        }
