...
public class CAEligibility extends javax.swing.JFrame {
    ...
    public void getCAeligibility(RSTableMetro table , String searchValue){
        String sql = "SELECT * FROM marks WHERE CONCAT(ug_id,course_id,quiz_1,quiz_2,quiz_3,quiz_4,assesment,mid_term,ca_marks,eligibility_status) LIKE ? ORDER BY ug_id ASC";
            ...
            try(ResultSet result = ps.executeQuery()){
                ...
                while(result.next()){
                    model.addRow(new Object[]{
                        ...
                        result.getString("ca_marks"),
                        result.getString("eligibility_status")
                    });
                }
            }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CA ELIGIBILITY ");
