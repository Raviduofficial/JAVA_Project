...
public class GPAcalculation extends javax.swing.JFrame {
    ...
    private void tableviewStudentGPA(){
        gPAcal.getGPA(tbl_gpa, "");
        model = (DefaultTableModel) tbl_gpa.getModel();
    }
    ...
    private void initComponents() {
        ...
        tbl_gpa = new rojeru_san.complementos.RSTableMetro();
        ...
        tbl_gpa.setFuenteHead(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        tbl_gpa.setRowHeight(30);
        ...
        jPanel13.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 190, 110));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jPanel13, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 777, Short.MAX_VALUE))
        );
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        if(txt_search.getText().isEmpty()){
            ...
            gPAcal.getGPA(tbl_gpa, txt_search.getText());
        }
    ...
    private rojeru_san.complementos.RSTableMetro tbl_gpa;
